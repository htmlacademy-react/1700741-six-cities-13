...
import OfferImgs from '../components/offer/offer-imgs';
    ...
    <div key={id} className="page">
      ...
      <main className="page__main page__main--offer">
        <section className="offer">
          <OfferImgs offer={currentOffer}></OfferImgs>
          <div className="offer__container container">
            <div className="offer__wrapper">
              <PlaceCardMark isPremium={currentOffer.isPremium} className={"offer__mark"}></PlaceCardMark>
              ...
              <section className="offer__reviews reviews">
               ...
               <OfferFormReview></OfferFormReview>
              </section>
            </div>
          </div>
